      ...
      <div className="about-info">
        ...
        <div className="bio">
          ...
          <p>
            ...
            capacity! I've always had a passion to create and while getting my
            EE degree, I realized that coding scratched that itch better! I'm
            currently working on a 100 Algorithm challenge, read all about it on
            my{' '}
            <b>
              <a href="https://medium.com/@aaronmassey45">blog</a>
            </b>! Outside of developing I have a beautiful girlfriend, a
            handsome son, and two good ole puppers. I'd love to get coffee and
            get to know you, so don’t hesitate to get in touch.
          </p>
        </div>
